...
<body <?php body_class(); ?> itemscope itemtype="https://schema.org/WebPage">
				...
				<div class="container">
					<div class="row">
						...
						<div class="site-navigation-inner col-md-12">
							...
							<?php mindful_header_menu(); // main navigation ?>
	...
	<div id="content" class="site-content">
		<div class="top-section">
			<?php mindful_featured_slider(); ?>
			<?php mindful_call_for_action(); ?>
		</div>
		<div class="container main-content-area">
			...
			?>
				<div class="main-content-inner <?php echo mindful_main_content_bootstrap_classes(); ?>">
