...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>  itemscope itemtype="https://schema.org/CreativeWork">
  ...
  <?php endif; ?>
	<div class="post-inner-content">
		<header class="entry-header page-header">
			...
			<div class="entry-meta  nomargin">
				...
				<?php  //mindful_author_name(); ?>
				<?php mindful_posted_on(); ?>
				<?php
					/* translators: used between list items, there is a space after the comma */
					$categories_list = get_the_category_list( esc_html__( ', ', 'mindful' ) );
				if ( $categories_list && mindful_categorized_blog() ) :
				?>
				<span class="cat-links meta-blocks"><i class="fa fa-folder-open-o fa-lg"></i> Category<br />
				<?php printf( esc_html__( ' %1$s', 'mindful' ), $categories_list ); ?>
				</span>
	...
	<?php if ( get_theme_mod( 'mindful_post_author_bio' ) == 1 ) : ?>
