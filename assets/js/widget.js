jQuery( document ).ready(function() {
    var mediaControl = {
        ...
        select: function() {
            ...
            var selector = jQuery( '.mindful-media-container' ).find( mediaControl.selector );
            var data = {
                action: 'mindful_get_attachment_media',
                attachment_id: id
            };
            ...
            jQuery.post( mindful.ajaxurl, data, function( response ) {
        ...
        init: function() {
            ...
            context.on( 'click', '.mindful-media-container .upload-button', function( e ) {
                var container = jQuery( this ).parents( '.mindful-media-container' ),
            ...
            context.on( 'click', '.mindful-media-container .remove-button', function( e ) {
                var container = jQuery( this ).parents( '.mindful-media-container' ),
                    sibling = container.find( 'input' ),
