...
function generateMobileMenu() {
    ...
    if ( mindfulIsMobile() && jQuery( window ).width() > 767 ) {
        menu.addClass( 'mindful-mobile-menu' );
    } else {
        menu.removeClass( 'mindful-mobile-menu' );
    }
}
...
jQuery( document ).ready(function() {
    ...
    jQuery( '.mindful-dropdown' ).click( function( evt ) {
